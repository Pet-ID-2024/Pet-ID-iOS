...
#Preview {
    AccessibilityItemView(item: AccessibilityItem( type: .phone, title: "기기 및 앱 기록", description: "앱 서비스 최적화 및 오류 확인", isMandatory: true, icon: DSImage.cameraicon.toImage()))
}
